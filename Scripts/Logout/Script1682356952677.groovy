...
WebUI.verifyElementText(findTestObject('Page_Social Network/span_Phng L'), 'Phùng Lý')

WebUI.click(findTestObject('Page_Social Network/button_Phng L'))

WebUI.click(findTestObject('Page_Social Network/li_ng xut'))
